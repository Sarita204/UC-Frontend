...
function Banner() {
  ...
  const deleteBanner = async (id) => {
    axios({
      method: "post",
      url: "https://coorgtour.in/api/admin/deleteBanner/" + id,
    })
      .then(function (response) {
        window.location.reload();
  ...
  const columns = [
    ...
    },
    {
      dataField: "tagline",
      text: "Sub header",
      formatter: (value, row) => <p>{row.tagline ? row.tagline : ""}</p>,
      headerStyle: { backgroundColor: "#080874", color: "white" },
    },
...

    {
      ...
      formatter: (value, row) => (
        <img
          src={"https://coorgtour.in/Banner/" + row?.img}
          alt=""
          width="50px"
          height="50px"
          onClick={() =>
            window.open("https://coorgtour.in/Banner/" + row?.img)
          }
        />
      ),
      headerStyle: { backgroundColor: "#080874", color: "white" },
      ...
      <Container>
            ...
            {(props) => (
              <div >
                <div className="d-flex mb-4" >
                  ...
                  {/* <SearchBar {...props.searchProps} style={{ display: "hidden" }} />
                  &nbsp; */}
        ...
        <Modal show={show} onHide={handleClose} className="modal1111111">
          ...
          <Modal.Footer>
            ...
            <Button variant="" onClick={addbanner} style={{
              background: "#080874 ",
              color: "white",
            }}>Add</Button>
          </Modal.Footer>
        ...
        >
                ...
                <div>
                  <label htmlFor="icon-button-file9">
                    ...
                    <img
                      src={
                        img1 === undefined
                          ? "https://coorgtour.in/Banner/" + editdata?.img
          ...
          <Modal.Footer>
            <Button variant="" onClick={handleeditClose} style={{
              border: "1px solid #080874 ",
              color: "#080874",
            }}>
              Cancel
            </Button>
            <Button variant="" onClick={() => editbaner(editdata)} style={{
              background: "#080874 ",
              color: "white",
            }}>Update</Button>
          </Modal.Footer>
