...
const SlotBooking = () => {
    ...
    const deleteSlotbooking = async (id) => {
        axios({
          method: "delete",
          url: "https://coorgtour.in/api/admin/deleteSlotbooking/" + id,
        })
          .then(function (response) {
...

        {
            ...
            formatter: (value, row) => (
                <>
                    ...
                    <button
                        style={{ border: "none", backgroundColor: "transparent" }}
                        onClick={()=>{deleteSlotbooking(row._id)}}
                    >
                ...
                <Container>
                    ...
                    <Modal show={show} onHide={handleClose} className="modal1111111">
                        ...
                        <Modal.Footer>
                            ...
                            <Button onClick={addSlotbooking}>Add</Button>
                        </Modal.Footer>
                    </Modal>
                    ...
                    >
                        ...
                        <Modal.Footer>
                            ...
                            <Button onClick={()=>{editSlotbooking(editdata)}}>Update</Button>
                        </Modal.Footer>
                    </Modal>
                </Container>
            </div>
