  ...
  return (
    <div style={{ padding: "2%" }}>
      ...
      <div style={{ paddingLeft: "25px" }}>
        <p>
          Welcome to <b> Easy Trace</b>.
        </p>
        <p>
          <b>Easy Trace</b> (“us”, “we”, or “our”) operates{" "}
          <a href="https://parnetsgroup.com/">https://parnetsgroup.com/</a>{" "}
          (hereinafter referred to as <b>“Service”</b>).
        </p>
        <p>
          Our Privacy Policy governs your visit to{" "}
          <a href="https://parnetsgroup.com/">https://parnetsgroup.com/</a>, and
      ...
      <div style={{ paddingLeft: "25px" }}>
        <p>
          ...
          <a href="https://parnetsgroup.com/">https://parnetsgroup.com/</a>{" "}
          website operated by Easy Trace.
        </p>
        <p>
      ...
      <div style={{ paddingLeft: "25px" }}>
        ...
        <p>
          <span>
            <FaRegHandPointRight color="navy" />
          </span>{" "}
          Email address
        </p>
        <p>
      ...
      <div style={{ paddingLeft: "25px" }}>
        <p>Easy Trace uses the collected data for various purposes:</p>
        <p>
          <span>
            <FaRegHandPointRight color="navy" />
          </span>{" "}
      ...
      <div style={{ paddingLeft: "25px" }}>
        ...
        <p>
          Easy Trace will take all the steps reasonably necessary to ensure that
      ...
      <div style={{ paddingLeft: "25px" }}>
        ...
        <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} <b>Other cases. We may disclose your information also:</b>
        </p>
        <p><span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} to our subsidiaries and affiliates;</p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} to contractors, service providers, and other third parties we
          use to support our business;
        </p>
        <p><span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} to fulfill the purpose for which you provide it;</p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} for the purpose of including your company’s logo on our
          website;
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} for any other purpose disclosed by us when you provide the
          information;
        </p>
        <p><span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} with your consent in any other cases;</p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} if we believe disclosure is necessary or appropriate to protect
      ...
      <div style={{ paddingLeft: "25px" }}>
        ...
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} the right to access, update or to delete the information we have
          on you;
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} the right of rectification. You have the right to have your
          information rectified if that information is inaccurate or incomplete;
        </p>
        <p>
        <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} the right to object. You have the right to object to our
          processing of your Personal Data;
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} the right of restriction. You have the right to request that we
          restrict the processing of your personal information;
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} the right to data portability. You have the right to be provided
        ...
        <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} the right to withdraw consent. You also have the right to
      ...
      <div style={{ paddingLeft: "25px" }}>
        ...
        <p><span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} users can visit our site anonymously;</p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} our Privacy Policy link includes the word “Privacy”, and can
          easily be found on the home page of our website;
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} users will be notified of any privacy policy changes on our
          Privacy Policy Page;
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} users are able to change their personal information by emailing
          us at <b>support@parnetsgroup.com</b>.
        </p>
      ...
      <div style={{ paddingLeft: "25px" }}>
        ...
        <p>
          ...
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} What personal information we have about you. If you make this
        ...
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} The categories of personal information we have collected about
          you.
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} The categories of sources from which we collect your personal
          information.
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} The business or commercial purpose for collecting or selling
          your personal information.
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} The categories of third parties with whom we share personal
          information.
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} The specific pieces of personal information we have collected
          about you.
        </p>
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} A list of categories of personal information that we have sold,
        ...
        <p>
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} A list of categories of personal information that we have
        ...
        <p>
          ...
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} To delete your personal information. If you make this request,
        ...
        <p>
          ...
          <span>
          <FaRegHandPointRight color='navy'   />
        </span>{" "} To stop selling your personal information. We don’t sell or
        ...
        <p>
          ...
          please send your request(s) by email: <b>support@parnetsgroup.com</b>.
        </p>
        <p>
      ...
      <div style={{ paddingLeft: "25px" }}>
        <p>
          ...
          by email: <b>support@parnetsgroup.com</b>.
        </p>
